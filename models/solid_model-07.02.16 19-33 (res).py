...
def create_CSYS():
    ...
    for j in JAWS:
        ...
        #res.append(a.DatumCsysByThreePoints(origin=d1[2], point1=d2[2], point2=v1[7], name = jaw + '_csys-'+str(csys_n), coordSysType=CARTESIAN))
...
if __name__ == "__main__":
    ...
    create_assembly(displ, outer, length, tanf, radf, axlf, anglef)
    a = mdb.models['Model-1'].rootAssembly
