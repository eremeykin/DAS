''' Тонкостенная модель, подготовленная для вычисления через силу
 - добавлено дополнительное сечение для центрального приложения силы к кулачук
 - исправлены граничные условия координаты 
 - взаимодействие по всей площади кулачка (теперь их 4 после разбиения) 
 Само вычисление пока через смещение, т.к. кулачи почему-то отходят в противоположную стророну,
 хотя заготовка деформируется правильно.'''
