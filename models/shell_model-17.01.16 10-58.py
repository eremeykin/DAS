...
def create_interaction():
    ...
    mid_d = float(inner-outer)/2+inner
    x1, y1, x2, y2 = __get_xy(mid_d, 120) 
    a = mdb.models['Model-1'].rootAssembly
    ...
    mid_d = float(inner-outer)/2+inner
    x1, y1, x2, y2 = __get_xy(mid_d, 240)
    a = mdb.models['Model-1'].rootAssembly
...
def create_CSYS():
    ...
    res.append(a.DatumCsysByThreePoints(origin=d11[2], point1=d2[2], point2=v11[7], 
        name='Datum csys-3', coordSysType=CARTESIAN))
    a = mdb.models['Model-1'].rootAssembly
    d12 = a.instances['Jaw-1-rad-3'].datums
    v12 = a.instances['Jaw-1-rad-3'].vertices
    res.append(a.DatumCsysByThreePoints(origin=d12[2], point1=d2[2], point2=v12[7], 
        name='Datum csys-4', coordSysType=CARTESIAN))
    return res
    
    
    #a.DatumCsysByThreePoints(origin=d1[2], point1=d2[2], point2=v11[7], name='Datum csys-5', coordSysType=CARTESIAN)
...
def create_displ(displ):
    ...
    mdb.models['Model-1'].DisplacementBC(name='BC-4', createStepName='Step-1', 
        region=region, u1=displ, u2=UNSET, u3=UNSET, ur1=UNSET, ur2=UNSET, 
